...
await exec(npmCommand, [...npmPrefix, "run", "gate"], { cwd: root });
await mkdir(artifacts, { recursive: true });
const { stdout: packOutput } = await exec(npmCommand, [...npmPrefix, "pack", "--json", "--pack-destination", "artifacts"], { cwd: root });
